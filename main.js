...
{
  let images = [
    {url: 'image/slide1.png', text: 'むらんちメンバーによるランチプロジェクト始動！',},
    {url: 'image/slide2.png', text: '[上野村視察] 大きな自然とおいしい食べ物！',},
    {url: 'image/slide3.png', text: '[レセプション] 実際に出すメニューをご用意！',},
    {url: 'image/slide4.png', text: 'いよいよ本日オープンです！',},
  ];
